...
To run program you need to install tensorflow, numpy, keras and matplotlib packages
...
models.save_weights('./model.h5', overwrite=True)
...
# Make a prediction
predictions = models.predict(testX[:1])
